...
SaiF = types.InlineKeyboardButton(text = "- MOATAZ AYED .", url = 'https://t.me/i_m_s')
channel = types.InlineKeyboardButton(text = "- 𝖬𝖾 𝖢𝗁𝖺𝗇𝗇𝖾𝖫 .", url = 'https://t.me/moatz')
...
- 𝖣𝖾𝗏𝖾𝖫𝗈𝖯𝖾𝗋 : @i_m_s""",parse_mode="markdown",reply_markup=mar)
    if str(id) != own_id:
    	bot.reply_to(message,text=f"""*- 𝖣𝖾𝗏𝖾𝖫𝗈𝖯𝖾𝗋 : @i_m_s*""",parse_mode="markdown",reply_markup=o)
